...
public class ArmConstants{
    ...
    public static final double[] cargoIntake = {52.81612660933514 + a,-113.52286529541016 + b}; //43 worked well
    //public static final double[] hatchIntake = {92.57064943897481 + a,-60.999507904052734 + b}; PRE-CONOR
    public static final double[] hatchIntake = {73.57064943897481 + a,-50.999507904052734 + b};
    ...
    public static final double[] hatch1 = {92.57064943897481 + a,-60.999507904052734 + b};
